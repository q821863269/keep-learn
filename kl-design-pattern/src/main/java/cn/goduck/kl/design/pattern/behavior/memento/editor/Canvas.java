...
import cn.goduck.kl.design.pattern.behavior.memento.command.ColorCommand;
import cn.goduck.kl.design.pattern.behavior.memento.command.MoveCommand;
    ...
    private void attachMouseListeners() {
        MouseAdapter colorizer = new MouseAdapter() {
            ...
            public void mousePressed(MouseEvent e) {
                ...
                cn.goduck.kl.design.pattern.behavior.memento.shape.Shape target = editor.getShapes().getChildAt(e.getX(), e.getY());
                if (target != null) {
